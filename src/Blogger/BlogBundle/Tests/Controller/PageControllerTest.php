...
class PageControllerTest extends WebTestCase
{
    ...
    public function testContact()
    {
        ...
        $this->assertEquals(1, $crawler->filter('h1:contains("Контакты MyBlog")')->count());
        ...
        $form['contact[body]'] = 'The comment body must be at least 50 characters long as there is a validation
            constrain on the Enquiry entity';
        ...
        $this->assertEquals(1, $crawler
            ->filter('.blogger-notice:contains("Ваш запрос успешно отправлен. Спасибо!")')->count());
